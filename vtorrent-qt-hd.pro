TEMPLATE = app
TARGET = vtorrent
VERSION = 0.8.1.1 #ba6535fa03eb7992df77092ae73bc1b1acf2605d
...
contains(VTR_NEED_QT_PLUGINS, 1) {
    DEFINES += VTR_NEED_QT_PLUGINS
...
macx:ICON = src/qt/res/icons/vtorrent.icns
macx:TARGET = "vTorrent"
