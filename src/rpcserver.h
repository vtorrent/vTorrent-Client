...
extern json_spirit::Value sendvtrtotoken(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value sendtokentotoken(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value sendtokentovtr(const json_spirit::Array& params, bool fHelp);
