...
static const unsigned int MAX_MULTI_BLOCK_SIZE = 5120000;    // 5mb, most likely to hit MAX_MULTI_BLOCK_ELEMNTS first
...
static const uint256 hashGenesisBlock("0x00000871bd87f95c062614541a3b5533280692b6a88d2dbea84339564dec8cc2");
static const uint256 hashGenesisBlockTestNet("0x00000529c45563ef0037459ebcead0debd6cf1066b91c7dfea5603eb25c963ad");
...
public:
    ...
    uint256 GetBlockHash() const
    {
        ...
        const_cast<CDiskBlockThinIndex*>(this)->blockHash = block.GetHash();
...
public:
    ...
    std::vector<std::pair<uint256, unsigned int> > vPrevTxnCandidates;
