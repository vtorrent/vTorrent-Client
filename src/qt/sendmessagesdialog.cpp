    ...
    type(type)
{
    ...
    if(mode == SendMessagesDialog::Encrypted)
        ui->addressFrom->setPlaceholderText(tr("Enter Your Standard address (e.g. XHRwRr9YeiknEMeyiZisWxtedtaLCqjxz6)"));
#endif
        ui->addressFrom->setFont(GUIUtil::bitcoinAddressFont());
    addEntry();
...
void SendMessagesDialog::on_sendButton_clicked()
{
    ...
    QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm send messages"),
                          tr("Are you sure you want to send this message?"),
