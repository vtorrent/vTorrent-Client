...
void StatisticsPage::updateStatistics()
{
    ...
    {
		subsidy = "15 VTR per block";
    }
    else if(pindexBest->nHeight < 15000)
    {
		subsidy = "1000 VTR per block";
    }
    ...
    {
        ui->volumeBox->setText("<b><font color=\"green\">" + qVolume + " VTR" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " VTR" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " VTR");
    }
